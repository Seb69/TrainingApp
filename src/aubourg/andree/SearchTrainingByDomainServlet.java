...
public class SearchTrainingByDomainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		System.out.println("DOMAIN SEARCH : " + searchString);
		
		//Filter
		Filter propertyFilter = new Query.FilterPredicate("domain",
